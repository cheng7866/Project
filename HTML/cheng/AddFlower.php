...
<form action="insertGarden.php" method="post" name="garden"> 
<div class="container">
  <h2>Add round</h2>
  ...
  <li class="table-row">
      <div class="col col-1" data-label="Name"><?php echo $x+1 ?></div>
      <div class="col col-2" data-label="Start Time"><input type="time" name="stime<?php echo $x ?>"></div>
      <div class="col col-3" data-label="End Time"><input type="time" name="etime<?php echo $x ?>"></div>
      <div class="col col-4" data-label="Price"><input type="integer" name="price<?php echo $x ?>"></div>
  ...
  <li class="table-header">
      <div class="col col-1" >No</div>
      <div class="col col-2" >NameThai</div>
      <div class="col col-3" >NameEnglisn</div>
      <div class="col col-4" >DescriptionFlower</div>
    </li>
  ...
  <li class="table-row">
      <div class="col col-1" data-label="No"><?php echo $x+1 ?></div>
      <div class="col col-2" data-label="NameThai"><input type="varchar" name="NameThai<?php echo $x ?>"></div>
      <div class="col col-3" data-label="NameEng"><input type="varchar" name="NameEng<?php echo $x ?>"></div>
      <div class="col col-4" data-label="DescriptionFlower"><input type="varchar" name="DescriptionFlower<?php echo $x ?>"></div>
