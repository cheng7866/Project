...
$StartTime= $objResult2['StartTime'];
$EndTime= $objResult2['EndTime'];


$msg = "สวนชื่อ: $name "."วันที่จอง: $bookingdate "."จำนวนผู้เข้าชม: $Numberofpeoplebooking "." เริ่มเวลา: $StartTime "."ถึง $EndTime ";
